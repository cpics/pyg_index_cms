<template>
  <div class="app-container">
    ...
    <el-table :data="list">
      ...
      <el-table-column label="案例企业" prop="company_name" />
      <el-table-column label="企业介绍" prop="company_content" />
      <el-table-column label="企业LOGO">
        <template slot-scope="scope">
          <img :src="scope.row.icon_image_key" style="width:100px;height:100px">
        </template>
      </el-table-column>
      <el-table-column label="大图">
        <template slot-scope="scope">
          <img :src="scope.row.image_key" style="width:100px;height:100px">
        </template>
      </el-table-column>
      <el-table-column label="排序" prop="sort_value" />
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button class="primary" @click="showUpdate(scope.$index)">修改</el-button>
...
<script>
import { FetchList, Add, Update, Del } from '@/api/case'
