<template>
  <div class="app-container">
    <el-button v-if="list.length<5" type="primary" @click="showAdd">
      添加{{ name }}
    </el-button>
    <el-table :data="list">
      ...
      <el-table-column label="产业方向" prop="industry_direction" />
      <el-table-column label="地址" prop="address" />
      <el-table-column label="背景图地址">
        <template slot-scope="scope">
          <img :src="scope.row.bg_image" style="width:100px;height:100px">
        </template>
      </el-table-column>
...
<script>
import { FetchList, Add, Update, Del } from '@/api/showSite'
